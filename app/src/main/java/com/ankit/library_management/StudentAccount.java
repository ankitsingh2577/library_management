...
public class StudentAccount extends AppCompatActivity {
    ...
    TextView txtName, txtEmail, txtUrn,txtCourse,txtYear, txtSem,txtMobile;
    private Button btnChangePass, btnLogout;
    private SessionManager session;
    private DatabaseHandler db;
    private ProgressDialog pDialog;
    private HashMap<String, String> user = new HashMap<>();
    public String Name,Surname,Fullname,Email,Urn,Batch,Sem,Phone,Course,Year;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!NetConnectivityCheck.isNetworkAvailable(StudentAccount.this)) {
            StudentAccount.ViewDialogNet alert = new StudentAccount.ViewDialogNet();
    ...
    private void init () {
        ...
        btnChangePass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(StudentAccount.this);
    ...
    private void logout_Conformation() {
        final androidx.appcompat.app.AlertDialog.Builder dialogBuilder = new androidx.appcompat.app.AlertDialog.Builder(StudentAccount.this);
