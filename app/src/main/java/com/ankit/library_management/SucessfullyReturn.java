...
public class SucessfullyReturn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sucessfully_return);
        ...
        ReturnBook(Qr_Result);
    }

    private void ReturnBook(final String code) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Functions.Return_Book_URL, new Response.Listener<String>() {
