...
public class LibrarianHomeActivity extends AppCompatActivity implements TabLayout.OnTabSelectedListener, DrawerAdapter.OnItemSelectedListener{
    ...
    private static final int UploadBook = 2;
    private static final int BlockUnblockuser = 3;
    private static final int ViewReturnBooks = 4;
    private static final int PendingAprovals = 5;
    private static final int ReturnBooks = 6;
    private static final int Share = 8;
    private static final int About = 9;
    private static final int Contact_Dev = 10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_librairian);
        ...
        if (!NetConnectivityCheck.isNetworkAvailable(LibrarianHomeActivity.this)) {
            ViewDialogNet alert = new LibrarianHomeActivity.ViewDialogNet();
            alert.showDialog(LibrarianHomeActivity.this, "Please, enable internet connection before using this app !!");
        }
        ...
        DrawerAdapter drawadapter = new DrawerAdapter(Arrays.asList(
                ...
                createItemFor(UploadBook),
                createItemFor(BlockUnblockuser),
                createItemFor(ViewReturnBooks),
                createItemFor(PendingAprovals),
                createItemFor(ReturnBooks),
                new SpaceItem(48),
                createItemFor(Share),
                createItemFor(About),
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                ListAdapter adapter = new SimpleAdapter(
                        LibrarianHomeActivity.this, JsonList,
                ...
                DetailsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        final TextView Available = (TextView) view.findViewById(R.id.available);
                        ...
                        quantity = Available.getText().toString();

                        Intent intent = new Intent(getApplication(), Librarian_Book_Info.class);
    ...
    public void onItemSelected(int position) {
        ...
        {
            startActivity(new Intent(this, LibrarianAccount.class));
            finish();
        }
        if (position== UploadBook)
        {
            startActivity(new Intent(this, AddBooks.class));
        }
        if (position== BlockUnblockuser)
        {
            startActivity(new Intent(this, BlockUnblockUserActivity.class));
        }
        if (position== PendingAprovals)
        {
            startActivity(new Intent(this, LibrarianScanIssue.class));
        }
        if (position== ReturnBooks)
        {
            startActivity(new Intent(this, LibrarianScanReturn.class));
        }
        if (position== ViewReturnBooks)
        {
            startActivity(new Intent(this, Librarian_View_Issued_Return.class));
        }
    ...
    private void logout_Conformation() {
        final androidx.appcompat.app.AlertDialog.Builder dialogBuilder = new androidx.appcompat.app.AlertDialog.Builder(LibrarianHomeActivity.this);
